...
const AddCar = () => {
    const {axios, currency, refreshDashboard} = useAppContext();
    ...
    const onSubmitHandler = async (e) => {
        ...
        try{
            ...
            if(data.success)
            {
                ...
                {
                    refreshDashboard();
                    console.log('Dashboard refresh triggered from AddCar');
                }
        ...
        <div className="px-4 py-10 md:px-10 flex-1">
            ...
            <form className="flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl" onSubmit={onSubmitHandler}>
                ...
                <div className="flex items-center gap-2 w-full">
                 ...
                 {/* Car Transmission, Fuel Type, Seat Capacity */}
                 <div className="grid grid-cols-1  sm:grid-cols-2 md:grid-cols-3 gap-6">
                    <div className="flex flex-col w-full">
                 ...
                 <div className="flex flex-col w-full">
                    ...
                    <textarea rows={5} placeholder="e.g. A luxurious SUV with a spacious interior and a powerful engine." required className="px-3 mt-1 border border-borderColor rounded-md outline-none" value={car.description} onChange={e => setCar({...car, description : e.target.value})}></textarea>
                 </div>
